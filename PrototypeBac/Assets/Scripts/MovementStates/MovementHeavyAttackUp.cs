...
public class MovementHeavyAttackUp : MovementState, IAttackState
{
    private float timer = 0.0f;

    public MovementHeavyAttackUp(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.Log("[Movement State]: Heavy Attack Up");
        Enter();
    }
