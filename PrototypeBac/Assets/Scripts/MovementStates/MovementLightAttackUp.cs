...
public class MovementLightAttackUp : MovementState, IAttackState
{
    private float timer = 0.0f;

    public MovementLightAttackUp(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.Log("[Movement State]: Light Attack Up");
        Enter();
    }
    public override void Enter()
    {
        ...
        m_Character.GetComponent<Animator>().SetTrigger("LightAttackUp");
