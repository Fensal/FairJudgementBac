...
public class BattleParryDown : BaseBattleParryDown
{
    private float timer = 0.0f;

    public BattleParryDown(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.Log("[Battle State]: Parry Down");
        Enter();
    }
