...
public class BattleLightAttackUp : BaseBattleLightAttackUp
{
    private float timer = 0.0f;

    public BattleLightAttackUp(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.Log("[Battle State]: Light Attack Up");
        Enter();
    }
