...
public class BattleHeavyAttackDown : BaseBattleHeavyAttackDown, IAttackState
{
    private float timer = 0.0f;

    public BattleHeavyAttackDown(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.Log("[Battle State]: Heavy Attack Down");
        Enter();
    }
