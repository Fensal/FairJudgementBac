...
public class AIBattleHeavyAttackDown : BaseBattleHeavyAttackDown, IAttackState
{
    private float timer = 0.0f;

    private bool flag = true;

    public AIBattleHeavyAttackDown(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.LogWarning("[AI Battle State]: Heavy Attack Down");
        Enter();
    }
    public override void Enter()
    {
        ...
        FMOD_StudioSystem.instance.PlayOneShot("event:/Enemy/enemy_attack_heavy", m_Character.transform.position);
