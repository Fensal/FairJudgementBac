...
public class AIBattleLightAttackDown : BaseBattleLightAttackDown, IAttackState
{
    private float timer = 0.0f;

    private bool flag = true;

    public AIBattleLightAttackDown(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.LogWarning("[AI Battle State]: Light Attack Down");
        Enter();
    }
