...
public class AIBattleHeavyAttackUp : BaseBattleHeavyAttackUp, IAttackState
{
    private float timer = 0.0f;

    private bool flag = true;

    public AIBattleHeavyAttackUp(BaseCharacterController basecharactercontroller)
        : base(basecharactercontroller)
    {
        Debug.LogWarning("[AI Battle State]: Heavy Attack Up");
        Enter();
    }
